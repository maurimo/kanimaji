...
def create_animation(filename):
    ...
    css_header = d("""
    /* CSS automatically generated by kanji_animator.py, do not edit! */
    """)
    if GENERATE_SVG:
    ...
    for g in doc.xpath("/n:svg/n:g", namespaces=namespaces):
        ...
        for p in g.xpath(".//n:path", namespaces=namespaces):
            ...
            bg_pathid = pathid+'-brd'
            bg_pathidcss = pathidcss+'-brd'
